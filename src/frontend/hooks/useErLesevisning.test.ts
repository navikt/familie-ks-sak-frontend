...
describe('useErLesevisning', () => {
    ...
    it('returnerer true når behandlingen er på vent', () => {
        mockUseBehandling.mockReturnValue(
            lagBehandling({
                behandlingPåVent: { frist: '2024-01-01', årsak: SettPåVentÅrsak.AVVENTER_BEHANDLING },
            })
        );
    ...
    it('returnerer true når behandlingen er etter BESLUTTE_VEDTAK', () => {
        mockUseBehandling.mockReturnValue(lagBehandling({ steg: BehandlingSteg.AVSLUTT_BEHANDLING }));
