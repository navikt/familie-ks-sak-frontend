...
import { ALL_COUNTRIES_REGION_CODES, type RegionCode, RegionCombobox } from '../../../FlagCombobox';
                ...
                <VStack gap={'space-24'}>
                    ...
                    {toggles[FeatureToggle.brukNyFlagCombobox] ? (
                        <RegionCombobox
                            label={'Land'}
                            value={
                                (skjema.felter.land.verdi !== '' ? skjema.felter.land.verdi : undefined) as RegionCode
                            }
                            options={ALL_COUNTRIES_REGION_CODES.filter(rc => {
