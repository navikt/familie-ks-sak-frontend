    ...
    switch (dataForManuellJournalføring.status) {
        ...
        case RessursStatus.IKKE_TILGANG:
            return (
                <GlobalAlert status={'error'}>
                    <GlobalAlert.Header>
                        <GlobalAlert.Title>Kan ikke vise journalføringsoppgave.</GlobalAlert.Title>
                    </GlobalAlert.Header>
                    <GlobalAlert.Content>
                        Personer relatert til journalpost har adressebeskyttelse. Krever ekstra tilganger.
                    </GlobalAlert.Content>
                </GlobalAlert>
            );
        default:
