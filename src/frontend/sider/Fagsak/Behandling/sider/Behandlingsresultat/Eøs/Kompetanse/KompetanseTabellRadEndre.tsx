            ...
            <VStack gap={'space-16'} maxWidth={'40rem'} paddingInline={'space-4 space-4'}>
                ...
                {toggles[FeatureToggle.brukNyFlagCombobox] ? (
                    <RegionCombobox
                        ...
                        value={skjema.felter.søkersAktivitetsland.verdi as RegionCode}
                        options={EØS_COUNTRIES_REGION_CODES}
                        onChange={value => {
                            if (value) {
                ...
                {toggles[FeatureToggle.brukNyFlagCombobox] ? (
                    <RegionCombobox
                        ...
                        value={skjema.felter.annenForeldersAktivitetsland.verdi as RegionCode}
                        options={EØS_COUNTRIES_REGION_CODES}
                        onChange={value => {
                            if (value) {
                ...
                {toggles[FeatureToggle.brukNyFlagCombobox] ? (
                    <RegionCombobox
                        ...
                        value={skjema.felter.barnetsBostedsland.verdi as RegionCode}
                        options={EØS_COUNTRIES_REGION_CODES}
                        onChange={value => {
                            if (value) {
