...
beforeEach(() => {
    ...
    useVedtaksperioderContextMock.mockReturnValue({
        vedtaksperioder: [
            lagVedtaksperiodeMedBegrunnelser({ begrunnelser: [{ begrunnelse: 'BEGRUNNELSE' } as never] }),
        ],
    });
...
describe('TilGodkjenning', () => {
    ...
    test('skal vise feilmelding når vedtaksbrevet mangler begrunnelse og behandling ikke kan foreslå vedtak uten', async () => {
        // Arrange
        useVedtaksperioderContextMock.mockReturnValue({
