...
export function ForhåndsvisVedtaksbrev() {
    ...
    function onVisVedtaksbrevClicked() {
        ...
        const erPåEllerEtterBeslutteVedtak = hentStegNummer(steg) <= hentStegNummer(BehandlingSteg.BESLUTTE_VEDTAK);
        const skalLagreBrev = erMinstSaksbehandler && erPåEllerEtterBeslutteVedtak;
        ...
        hentEllerOpprettVedtaksbrevPdf({ httpMethod, behandlingId, urlSegment });
