    ...
    return (
        <Box marginInline={'space-32 space-0'}>
            <Textarea
                ...
                name={name}
                label={
                    <HStack align="center" justify="space-between" wrap={false} width={'100%'}>
                            ...
                            <HelpText placement="right">
                                <Box maxWidth={'20rem'}>
                                    ...
                                    <BodyLong size="small" spacing={true}>
                                        ...
                                        rett på kontantstøtte når du oppholder deg utenlands. Da vi mottok meldingen fra
                                        deg, var det allerede utbetalt kontantstøtte for perioden (Fom dato - Tom dato).
                                    </BodyLong>
                                    <Link
