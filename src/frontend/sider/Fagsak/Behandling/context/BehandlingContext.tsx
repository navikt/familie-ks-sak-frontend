...
export const BehandlingProvider = ({ behandling, children }: Props) => {
    ...
    const vurderErLesevisning = (sjekkTilgangTilEnhet = true, skalIgnorereOmEnhetErMidlertidig = false): boolean => {
        ...
        const innloggetSaksbehandlerSkrivetilgang = saksbehandler.harSkrivetilgang();
        const innloggetSaksbehandlerHarSuperbrukerTilgang = saksbehandler.harSuperbrukerTilgang();
        ...
        const saksbehandlerHarTilgangTilEnhet =
            ...
            harTilgangTilEnhet(behandling.arbeidsfordelingPåBehandling.behandlendeEnhetId ?? '', [
    ...
    const kanBeslutteVedtak =
        ...
        BehandlerRolle.BESLUTTER === saksbehandler.hentRolle() &&
